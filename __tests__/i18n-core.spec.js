...
describe('i18n', function() {
    ...
    it('should return "keyset:key" if it does not exist in data', function() {
        expect(i18n('undefkeyset', 'undefkey')).toEqual('undefkeyset:undefkey');
        expect(i18n('keyset1', 'undefkey')).toEqual('keyset1:undefkey');
    });

    it('should return string value', function() {
        expect(i18n('keyset1', 'key1')).toEqual('keyset1 key1 string');
    });

    it('should return value as function result', function() {
        expect(i18n('keyset1', 'key2', { a : '1' })).toEqual('keyset1 key2 function {"a":"1"}');
    });

    it('should properly call another i18n items', function() {
        expect(i18n('keyset1', 'key3', { b : '2' })).toEqual('keyset1 key3 keyset1 key2 function {"b":"2"}');
    });
    ...
    it('should properly extend existed data', function() {
        ...
        expect(i18n('keyset1', 'key0')).toEqual('keyset1 key0 string');
        expect(i18n('keyset1', 'key1')).toEqual('keyset1 key1 new string');
        expect(i18n('keyset1', 'key2', { a : '1' })).toEqual('keyset1 key2 function {"a":"1"}');
        expect(i18n('keyset2', 'key1')).toEqual('keyset2 key1 string');
    });
});
